# Udagram Image Filtering Application  [![Build Status](https://app.travis-ci.com/AntonioDaria/Microservices-project.svg?branch=master)](https://app.travis-ci.com/AntonioDaria/Microservices-project)
